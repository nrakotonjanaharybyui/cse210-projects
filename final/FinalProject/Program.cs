...
class Program
{
    ...
    private static bool LoadBudget(Budget budget) // #3 Load a budget from file
    {
        Console.Clear();
    ...
    private static void ModifyItem(Budget budget, bool budgetExist) // #6 Modify an item on the current budget
    {
        throw new NotImplementedException();
    }
